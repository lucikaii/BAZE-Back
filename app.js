...
app.get('/v1/baze/generos', cors(), async function(request, response, next){
...
app.get('/v1/baze/genero/:id', cors(), async function(request, response, next){
...
app.post('/v1/baze/genero', cors(), jsonBodyParser, async function(request, response, next){
...
app.delete('/v1/baze/genero/:id', cors(), async function(request, response, next){
...
app.put('/v1/baze/atualizar/genero/:id', cors(), jsonBodyParser, async function(request, response, next){
...
app.get('/v1/baze/produto/genero/:id', cors(), async function(request, response, next){
...
app.post('/v1/baze/produto/genero', cors(), jsonBodyParser, async function(request, response, next){
